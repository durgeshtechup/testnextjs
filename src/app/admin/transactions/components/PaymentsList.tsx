...
import visa from "/src/assets/img/payment-clients/Aurea_via.png";
...
console.log("MasterCard",MasterCard)
  ...
  const getCardSVG = (type: string) => {
    switch (type) {
      case 'VISA':
        return <Image className="w-5 h-5" width={12} height={12}  title={type} src={`${visa}`} alt={`${type}`} />
      case 'MasterCard':
        return <Image className="w-5 h-5" width={12} height={12} title={type} src={`${MasterCard}`} alt={`${type}`} />
      case 'Discover':
        return <Image className="w-5 h-5" width={12} height={12}  title={type} src={`${Discover}`} alt={`${type}`} />
      case 'Amex':
        return <Image  className="w-5 h-5" width={12} height={12} title={type} src={`${Amex}`} alt={`${type}`} />
      case 'MaestroCard':
        return <Image className="w-5 h-5" width={12} height={12} title={type} src={`${MaestroCard}`} alt={`${type}`} />
      case 'DinersClub':
        return <Image className="w-5 h-5" width={12} height={12} title={type} src={`${DinersClub}`} alt={`${type}`} />
      case 'JCB':
        return <Image className="w-5 h-5" width={12} height={12} title={type} src={`${JCB}`} alt={`${type}`} />
      case 'UnionPay':
        return <Image className="w-5 h-5" width={12} height={12} title={type} src={`${UnionPay}`} alt={`${type}`} />
