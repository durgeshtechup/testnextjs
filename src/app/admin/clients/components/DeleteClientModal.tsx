...
const DeleteClientModal = ({ id, fetchClients }: { id: string, fetchClients: () => void }) => {
  ...
  return (
    <>
      <button className="text-orange-500 outline-none dark:text-red-400" title="Delete">
        <MdDelete
        ...
        <ModalContent className="z-[1002] !m-auto !p-3 sm:my-8 sm:w-full max-w-[800px] sm:max-w-xxl flex justify-center min-h-[100vh]">
          <ModalBody>
            ...
            <Card extra="px-[30px] pt-[38px] pb-5 max-w-[800px]  flex flex-col !z-[1004]">
              ...
              <p>
                This will delete the client which is irreversible action. Do you still want to continue?
              </p>
