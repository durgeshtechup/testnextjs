...
function Tokenlist(
    ...
    const handleVerifyTokenId = () => {
        let payload = {
            ...
            otp: tokenVerifyIput?.passCode,
            token_unique_id: tokenVerifyIput?.token_unique_id
        }


        verifyTokenId(payload).then((data) => {
                                                                ...
                                                                <div className="flex items-center text-sm font-normal text-navy-700 dark:text-white">
                                                                                        ...
                                                                                        onClick={() => {
                                                                                            ...
                                                                                            getProfile().then((data) => {
                                                                                                ...
                                                                                                setTokenVerifyIput((prev: any) => {
                                                                                                    return {
                                                                                                        ...prev,
                                                                                                        token_unique_id: cell?.row?.original?.id,
                                                                    ...
                                                                    {(cell?.column?.id == "id" && cell.value)
                                                                        ? cell?.row?.original?.claimed ? <>
                                                                            <BiSolidBadgeCheck title='Active' className='text-green-500 h-5 w-5  ml-2' />
                                                                        </>
                                                                            : <>
                                                                                <BiSolidBadgeCheck title='Used' className='text-gray-400 h-5 w-5 ml-2' />
                    ...
                    <ModalBody className="">
                        <Card extra="px-[30px] pt-[35px] pb-[20px] max-w-[450px] flex flex-col !z-[1004] ">
                            {!tokenVerifyIput?.is_auth_2fa_activate ? <>
                                ...
                                <p className="opacity-50">To see the Token Id please verify 2FA code.</p>
                                <br />

                                <p className="">Your account does not meet the necessary requirements in order to see Token Id, please visit <Link href="/admin/profile" className='text-indigo-500'>profile settings</Link> and activate 2FA code.</p>
